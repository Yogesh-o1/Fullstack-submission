...
sequenceDiagram
  ...
  browser->>server:HTTP GET https://studies.cs.helsinki.fi/exampleapp/new note spa
  activate server
  ...
  browser-->server: browser wont reload as it is spa and stops sending http request
